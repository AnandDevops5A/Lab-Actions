    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        ...
        <input
          ...
          className="bg-gray-800 border border-gray-700 rounded px-3 md:px-4 py-2 text-white text-xs md:text-sm focus:border-orange-500 outline-none w-full sm:w-auto"
        />
      </div>
        ...
        <table className="w-full text-xs md:text-sm">
          <thead className="bg-gray-900 border-b border-gray-700">
            <tr>
              ...
              <th className="px-3 md:px-6 py-3 md:py-4 text-left font-bold text-gray-300 hidden md:table-cell">Action</th>
          ...
          <tbody>
            {participants.map((p, idx) => (
              ...
              >
                ...
                <td className="px-3 md:px-6 py-3 md:py-4 text-gray-300 hidden sm:table-cell">
                  {p.totalPlay || 0}
                </td>
                ...
                <td className="px-3 md:px-6 py-3 md:py-4 hidden md:table-cell">
                                  <span className={`px-2 md:px-3 py-1 rounded-full text-xs font-bold ${ p.active ? 'bg-green-500/20 text-green-400' : 'bg-red-500/20 text-red-400'
                                    }`}>
