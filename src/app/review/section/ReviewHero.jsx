...
const ReviewHero = ({setFilters,reviews,tournaments,filters}) => {
  ...
  return (
     <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-8  mt-20">
        <div className=" overflow-hidden rounded-2xl border border-white/10 bg-linear-to-br from-gray-900/60 to-black/70 p-6 sm:p-10 backdrop-blur-md">
