export const callSignSVG = (<svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#00fff0]/90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
export  const emailSVG =(<svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#9b59ff]/80" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
export const gameIdSVG = (<svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#ff0055]/90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
...
export const tournamentSVG = (<svg className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#ff7a00]/90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
