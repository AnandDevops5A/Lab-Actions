  ...
  return (
    ...
    >
      ...
      <Image
        ...
        quality={75}
        placeholder="blur"
        className={`${isDarkMode ? "opacity-40" : "opacity-30"
          } saturate-125 brightness-${isDarkMode ? "50" : "75"
          } transition-all duration-700 ease-in-out animate-zoomLoop`}
      />

      {/* Professional Overlay with Theme-Aware Gradient */}
      <div
        className={`absolute inset-0 z-0 transition-colors duration-300 ${isDarkMode
...
>
 ...
 raging
          ...
          <h1
            className={`text-[55px] md:text-7xl lg:text-[90px] font-black mb-6 tracking-tighter drop-shadow-2xl leading-tight  transition-colors ${isDarkMode ? "text-slate-200" : "text-slate-800"
              }`}
          >
            Coming Soon
            <span
        ...
        <div
          className={`mb-4 text-sm md:text-base font-semibold tracking-widest uppercase ${isDarkMode ? "text-cyan-400" : "text-blue-600"
            }`}
        >
        ...
        <p
          className={`animate-slideInDown text-lg md:text-xl lg:text-2xl mb-8 max-w-3xl mx-auto drop-shadow-lg font-light leading-relaxed transition-colors ${isDarkMode ? "text-gray-200" : "text-slate-700"
            }`}
        >
          {/* <TypingWrapper> */}
          Unleash your skill into raw Bounty💰.<br />Dominate {''}
          <span
        ...
        <div
          className={`grid grid-cols-3 gap-4 max-w-2xl mx-auto mb-10 p-6 rounded-2xl backdrop-blur-md border transition-all ${isDarkMode
        ...
        >
          <div className="text-center">
            <div
              className={`text-3xl font-black mb-2 ${isDarkMode ? "text-cyan-400" : "text-blue-600"
                }`}
            >
              1000+
            </div>
            <div
              className={`text-xs font-medium tracking-widest uppercase ${isDarkMode ? "text-gray-400" : "text-slate-600"
                }`}
            >
              Players
            </div>
          ...
          >
            <div
              className={`text-3xl font-black mb-2 ${isDarkMode ? "text-purple-400" : "text-indigo-600"
                }`}
            >
              50+
            </div>
          ...
          <div className="text-center">
            <div
              className={`text-3xl font-black mb-2 ${isDarkMode ? "text-pink-400" : "text-red-600"
                }`}
            >
              10L+
            </div>
        ...
        <div className={`${buttonClasses} justify-center items-center`}>
          ...
          <button
            className={`group relative inline-flex items-center justify-center px-10 py-4 text-lg font-bold uppercase tracking-widest border-2 rounded-lg transition-all duration-300 hover-lift hover-glow ${isDarkMode
        ...
        {/* Scroll Indicator */}
        <div
          className={`absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce transition-colors ${isDarkMode ? "text-cyan-400" : "text-blue-600"
            }`}
        >
          <svg
            className="w-8 h-8"
