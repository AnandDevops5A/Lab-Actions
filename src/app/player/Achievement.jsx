...
const Achievement = ({ matchHistory, userId }) => (
          ...
          >
            <div>
              ...
              <p className="text-xs text-gray-400">
                {match.rankList[userId] < 4
                  ? `🪙: ${
                      (match.rankList[userId] === 1 && 500) ||
                      (match.rankList[userId] === 2 && 200) ||
                      (match.rankList[userId] === 3 && 100)
                    }`
                  : `Chaser`} | Invest : ₹ {match.invest[userId]}
              </p>
            </div>
